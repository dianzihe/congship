...
public:
	...
	virtual void		setText(  std::string& strText, int fontSize );
	virtual void		setText(  std::string& strText, int fontSize, int alignType );
	virtual void		setText(  std::string& strText, int fontSize, Size &size, int alignType , bool isAutoNewLine=true );
	virtual void		setText(  std::string& strText, int fontSize, Size &size, int alignType , string fontName, bool isAutoNewLine=true );
	...
	int						getParam64( void )const		{ return m_nParam64; }
	void					setParam64( int n )		{ m_nParam64 = n; }
