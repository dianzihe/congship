...
bool g_DoTouch = true;
bool UIManager::ccTouchBegan(CCTouch* touch, CCEvent* event)
{
#if 0
#ifdef USED_JUMP
	m_draged = 0;
...
void UIManager::ccTouchEnded(CCTouch* touch, CCEvent* event)
{
#if 0
    if(!g_DoTouch) return;
	m_curPos = touch->locationInView();
...
void UIManager::ccTouchesBegan(CCSet *pTouches, CCEvent *pEvent)
{
#if 0
	cc_timeval now;
